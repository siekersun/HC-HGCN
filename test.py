...
from train import evaluate as eva1
from HGNN_train import evaluate as eva2
...
if __name__ == "__main__":
    ...
    state_dict = torch.load(f'{output_dir}/best_model.pt', weights_only=True)
